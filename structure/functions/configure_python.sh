...
pip3 config set global.extra-index-url https://aws:$CODEARTIFACT_AUTH_TOKEN@my_domain-781648067507.d.codeartifact.region.amazonaws.com/pypi/FactoryRepository/simple/
