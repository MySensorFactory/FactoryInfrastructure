...
pip3 config set global.extra-index-url https://aws:${CODEARTIFACT_AUTH_TOKEN}@factory-781648067507.d.codeartifact.eu-central-1.amazonaws.com/pypi/FactoryRepository/simple/
